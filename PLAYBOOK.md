...
- AI 생성 이미지 **활용 가능**. 비주얼 부족 시 AI 생성·스톡·클라이언트 사진 자유 조합 (단 before/after 등 실제 시술 결과는 사실대로)
...
- [ ] **사진 퀄리티 확인** — 흐릿하거나 잘린 사진은 미리 재요청. 부족하면 AI 생성·스톡으로 보완 가능
...
- **"AI 이미지로 채워주세요"** → 가능. 부족한 비주얼은 AI 생성으로 보완 (실제 시술 결과 사진은 사실대로)
